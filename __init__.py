...
def init(
    ...
    _event_utils.KeyDown_EVENT()
    _event_utils.KeyUp_EVENT()
    _event_utils.KeyMapChanged_EVENT()
    _event_utils.LocaleChanged_EVENT()
    _event_utils.MouseMotion_EVENT()
    _event_utils.MouseButtonDown_EVENT()
    _event_utils.MouseButtonUp_EVENT()
    _event_utils.MouseWheel_EVENT()
    ...
    _event_utils.TextInput_EVENT()
    _event_utils.TextEditing_EVENT()
    _event_utils.VideoResize_EVENT()
    _event_utils.VideoExpose_EVENT()
