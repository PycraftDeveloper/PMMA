...
class LoadedShaderReferenceManager:
    ...
    def wait_for_shader_filling(self):
        return self._shader_intermediary.loaded_shaders_from_file != {} or self._enable_reference_checking is False or self._loaded_shaders_from_file_changed
...
class ShaderManager:
    ...
    def get_shader(self, file_name, shader_type=Constants.BOTH):
        if self.check_if_shader_exists(file_name, shader_type):
            if shader_type == Constants.BOTH:
                return ShaderIntermediary.loaded_shaders_from_file[file_name]["vertex"], ShaderIntermediary.loaded_shaders_from_file[file_name]["fragment"], ShaderIntermediary.loaded_shaders_from_file[file_name]["using_gl_point_size_syntax"], ShaderIntermediary.loaded_shaders_from_file[file_name]["uniform_values"], ShaderIntermediary.loaded_shaders_from_file[file_name]["buffer_names"]
            elif shader_type == Constants.VERTEX_ONLY:
                return ShaderIntermediary.loaded_shaders_from_file[file_name]["vertex"], ShaderIntermediary.loaded_shaders_from_file[file_name]["using_gl_point_size_syntax"], ShaderIntermediary.loaded_shaders_from_file[file_name]["uniform_values"], ShaderIntermediary.loaded_shaders_from_file[file_name]["buffer_names"]
            elif shader_type == Constants.FRAGMENT_ONLY:
                return ShaderIntermediary.loaded_shaders_from_file[file_name]["fragment"], ShaderIntermediary.loaded_shaders_from_file[file_name]["using_gl_point_size_syntax"], ShaderIntermediary.loaded_shaders_from_file[file_name]["uniform_values"], ShaderIntermediary.loaded_shaders_from_file[file_name]["buffer_names"]
