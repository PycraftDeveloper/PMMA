            ...
            for render_point in self._render_points:
                if type(render_point) == _Line:
                    ...
                    if render_point.get_vertices_changed():
                        ...
                        start = _numpy.array(render_point.get_start(format=Constants.OPENGL_COORDINATES), dtype=_numpy.float32)
                        end = _numpy.array(render_point.get_end(format=Constants.OPENGL_COORDINATES), dtype=_numpy.float32)
                    ...
                    if render_point.get_color_changed():
                        ...
                        render_point.set_colors_hardware_accelerated_data(_numpy.array([
                            *render_point.get_color(format=Constants.SMALL_RGB),
                            *render_point.get_color(format=Constants.SMALL_RGB),
                            *render_point.get_color(format=Constants.SMALL_RGB),
                            *render_point.get_color(format=Constants.SMALL_RGB),
                    ...
                    if render_point.get_vertices_changed():
                        render_point.set_vertices_changed(False)
                        vertices_list = []
                        for point in render_point.get_points(format=Constants.CONVENTIONAL_COORDINATES):
                    ...
                    if render_point.get_color_changed():
                        ...
                        for _ in render_point.get_points():
                            colors_list.extend([*render_point.get_color(format=Constants.SMALL_RGB)])
                    ...
                    if render_point.get_vertices_changed():
                        render_point.set_vertices_changed(False)
                        half_width = render_point.get_radius(format=Constants.OPENGL_COORDINATES)
                        half_height = render_point.get_height(format=Constants.OPENGL_COORDINATES) / 2
                        ...
                        vertices_list = [
                            (render_point.get_center_of_rect(format=Constants.CONVENTIONAL_COORDINATES)[0] + cos_angle * half_width - sin_angle * half_height),
                            render_point.get_center_of_rect(format=Constants.CONVENTIONAL_COORDINATES)[1] + sin_angle * half_width + cos_angle * half_height,
                    ...
                    if render_point.get_vertices_changed():
                        ...
                        render_point.set_vertices_hardware_accelerated_data(_numpy.array([
                            (render_point.get_position(format=Constants.OPENGL_COORDINATES)[0]),
                            render_point.get_position(format=Constants.OPENGL_COORDINATES)[1],
                            (render_point.get_position(format=Constants.OPENGL_COORDINATES)[0] + render_point.get_size(format=Constants.OPENGL_COORDINATES)[0]),
                            render_point.get_position(format=Constants.OPENGL_COORDINATES)[1],
                            (render_point.get_position(format=Constants.OPENGL_COORDINATES)[0] + render_point.get_size(format=Constants.OPENGL_COORDINATES)[0]),
                            render_point.get_position(format=Constants.OPENGL_COORDINATES)[1] + render_point.get_size(format=Constants.OPENGL_COORDINATES)[1],
                            (render_point.get_position(format=Constants.OPENGL_COORDINATES)[0]),
                            render_point.get_position(format=Constants.OPENGL_COORDINATES)[1] + render_point.get_size(format=Constants.OPENGL_COORDINATES)[1]]))
                    ...
                    if render_point.get_vertices_changed():
                        render_point.set_vertices_changed(False)
                        vertices_list = [*render_point.get_position(format=Constants.OPENGL_COORDINATES)]  # Center point of the arc
                        ...
                        for i in range(num_arc_segments + 1):
                            ...
                            x = render_point.get_position(format=Constants.OPENGL_COORDINATES)[0] + render_point.get_size(format=Constants.OPENGL_COORDINATES)[0] * _numpy.cos(angle)
                            y = render_point.get_position(format=Constants.OPENGL_COORDINATES)[1] + render_point.get_size(format=Constants.OPENGL_COORDINATES)[1] * _numpy.sin(angle)
                            vertices_list.extend([x, y])
                    ...
                    if render_point.get_vertices_changed():
                        render_point.set_vertices_changed(False)
                        vertices_list = []
                        for point in render_point.get_points(format=Constants.OPENGL_COORDINATES):
                            vertices_list.extend([point[0], point[1]])
                    ...
                    if render_point.get_vertices_changed():
                        render_point.set_vertices_changed(False)
                        vertices_list = [*render_point.get_position(format=Constants.OPENGL_COORDINATES)]
                    ...
                    if render_point.get_vertices_changed():
                        render_point.set_vertices_changed(False)
                        vertices_list = [*render_point.get_position(format=Constants.OPENGL_COORDINATES)]  # Circle center

                        radius = (1 / self._display.get_width())

                        for i in range(num_segments):
                            angle = (2 * _numpy.pi * i / num_segments) - _numpy.pi / 4
                            x = render_point.get_position(format=Constants.OPENGL_COORDINATES)[0] + radius * _numpy.cos(angle)
                            y = render_point.get_position(format=Constants.OPENGL_COORDINATES)[1] + radius * _numpy.sin(angle)
                            vertices_list.extend([x, y])
                    ...
                    if render_point.get_vertices_changed():
                        ...
                        for t in t_values:
                            ...
                            for i, point in enumerate(render_point.get_points(format=Constants.OPENGL_COORDINATES)):
