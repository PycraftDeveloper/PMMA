...
.. cpp:class:: Display_Create_Kwargs
...
.. cpp:class:: Display_Refresh_Kwargs
...
.. cpp:function:: void Display::Create(unsigned int* NewSize, Display_Create_Kwargs kwargs = {})
    ...
    :param Display_Create_Kwargs kwargs: Used to customize the default window parameters.
...
.. cpp:function:: void Display::CenterWindow()
...
.. cpp:function:: void Display::Clear()

    This method is used to clear all rendered graphics from the previous frame, and also used to apply the specified background color defined in :code:`Display::WindowFillColor`.

    .. note:: This method must be called from the same thread that the window was created in.

    .. warning:: A valid window must be created using :code:`Display::Create` before calling this method.

.. cpp:function:: void Display::SetWindowInFocus()

    This method is used to force the created window to be put into focus.

    .. warning:: A valid window must be created using :code:`Display::Create` before calling this method.

.. cpp:function:: void Display::GetIsWindowMinimized(bool value)
...
.. cpp:function:: void Display::SetWindowMaximized(bool value)
...
.. cpp:function:: void Display::SetIcon(std::string icon_path)
...
.. cpp:function:: void Display::SetCaption(std::string caption)
...
.. cpp:function:: void Display::SetRelativeWindowPosition(unsigned int* position)
...
.. cpp:function:: void Display::SetAbsoluteWindowPosition(unsigned int* position)
...
.. cpp:function:: void Display::Refresh(Display_Refresh_Kwargs kwargs = {})
    ...
    :param Display_Refresh_Kwargs kwargs: Used to customize the default refresh parameters.
...
.. cpp:function:: void Display::GetCenterPosition(unsigned int* ObjectSize, unsigned int* out)
...
.. cpp:function:: float Display::GetAspectRatio()
...
.. cpp:function:: unsigned int Display::GetFrameRate()
...
.. cpp:function:: float Display::GetFrameTime()
...
.. cpp:function:: unsigned int Display::GetWidth()
...
.. cpp:function:: unsigned int Display::GetHeight()
...
.. cpp:function:: void Display::GetSize(int* out)
...
.. cpp:function:: unsigned int Display::GetWindow_MSAA_Samples()
...
.. cpp:function:: unsigned int Display::GetCurrentMonitorRefreshRate()
...
.. cpp:function:: void Display::ToggleFullScreen()

    This method is used to switch the window between full screen and windowed modes.

    .. warning:: A valid window must be created using :code:`Display::Create` before calling this method.

.. cpp:function:: bool Display::GetIsWindowInFocus()
...
.. cpp:function:: bool Display::GetIsWindowMinimized()
...
.. cpp:function:: bool Display::GetIsWindowMaximized()
...
.. cpp:function:: bool Display::GetIsWindowResizable()
...
.. cpp:function:: bool Display::GetIsWindowVisible()
...
.. cpp:function:: bool Display::GetIsWindowAlwaysOnTop()
...
.. cpp:function:: bool Display::GetIsWindowUsingVsync()
...
.. cpp:function:: bool Display::GetIsWindowAutoMinimize()
...
.. cpp:function:: void Display::GetOrthographicProjection(float* out)
...
.. cpp:member:: Color* Display::WindowFillColor
