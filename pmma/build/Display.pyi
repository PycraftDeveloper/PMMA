...
from pmma.build.Types import Color
...
class Display:
    ...
    def refresh(self, min_refresh_rate: int=5,
        ...
        :param Union[int, None] max_refresh_rate: The maximum refresh rate to dynamically adjust up to. There is no guarantee this value will be achieved - but the window should not refresh at a faster rate for extended period of times. If set to :code:`None` the window refresh rate will be capped at either 60 when not using vsync, or allowed to run up to the vsync limit.
