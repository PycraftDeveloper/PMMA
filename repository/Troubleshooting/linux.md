...
- [`OSError: PortAudio library not found`](https://github.com/Project-PMMA/PMMA/blob/main/repo/Troubleshooting/linux.md#oserror-portaudio-library-not-found)
...
Then reinstall `sounddevice` with: `pip install --force-reinstall sounddevice`. Please note that this command may change your version of `sounddevice` to one that may be incompatible with PMMA, to check head to: `requirements.txt` or our [Dependency Graph](https://github.com/Project-PMMA/PMMA/network/dependencies).
