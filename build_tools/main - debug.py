...
import os, platform, shutil, site, subprocess, multiprocessing, sys, time
...
print("THIS IS BUILDING THE DEBUGGING VERSION OF PMMA")
time.sleep(3)
...
if not os.path.exists(temp_platform_cache_dir):
    ...
    if not os.path.exists(extern_lib_dir):
        ...
        if operating_system_type == "Windows":
            targets = {"freetyped": False, "glfw3": False, "harfbuzz": False, "libpng16d": False, "zlibd": False}
        else:
