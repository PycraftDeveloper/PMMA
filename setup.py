...
ext_modules = [
    ...
    make_ext(os.path.join("Events", "Events.pyx")),
    make_ext(os.path.join("Events", "KeyEvents.pyx"), raw_depends=["Events.pyx"]),
    make_ext(os.path.join("Events", "KeyPadEvents.pyx"), raw_depends=["Events.pyx"]),
